class Transaction:
    ...
    def changed(self):
        ...
        return self.after - self.before != 0
    ...
    def report(self):
        ...
        if self.changed():
            ...
            if self.after - self.before < 0:
                flag = 'decreased'
            msg = flag + ' ' + str(self.before) + '->' + str(self.after)
...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        new_transaction = Transaction(self.id, before_balance, after_balance)
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            new_transaction = Transaction(self.id, self.balance, self.balance)
            self.transactions.append(new_transaction)
            self.id += 1
