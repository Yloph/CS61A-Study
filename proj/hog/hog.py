...
def boar_brawl(player_score, opponent_score):
    ...
    return 3 * abs(tens_digit - ones_digit) or 1
    # END PROBLEM 2
...
def sus_update(num_rolls, player_score, opponent_score, dice = six_sided):
    ...
    res = player_score
    if num_rolls == 0:
        res = sus_points(boar_brawl(player_score, opponent_score) + player_score)
    else:
        res = sus_points(simple_update(num_rolls, player_score, opponent_score, dice))
...
def always_roll(n):
    ...
    assert n >= 0 and n <= 10
    # BEGIN PROBLEM 6
    def num_rolls(score, opponent_score):
        return n
...
def final_strategy(score, opponent_score, goal = GOAL):
    ...
    if sus_update(0, score, opponent_score) >= goal:
        ...
        score_0 = sus_update(0, score, opponent_score) - score
        ave_6 = make_averaged(sus_update, 50)(6, score, opponent_score) # 样本量小一些就能过
        if score_0 >= ave_6:
            return 0
        else:
            return 6
